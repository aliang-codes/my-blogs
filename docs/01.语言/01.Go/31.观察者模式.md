...
## 一、背景
* 最近看到zookeeper相关的文章，发现其本质是文件系统+观察者设计模式的分布式管理框架，包括 consul 等框架也是使用了观察者设计模式，而观察者模式实际上与 [sync.Cond](https://aliang-codes.github.io/my-blogs/pages/a2b7bc/) 库功能类似，准备写一篇相关的文章。
