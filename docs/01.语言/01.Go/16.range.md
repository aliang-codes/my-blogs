...
```
* 其中`mapiterinit`函数用于初始化迭代器，`mapiternext`用于迭代器的遍历，详见[go 容器之 map](https://aliang-codes.github.io/my-blogs/pages/93395a/#_11-mapiterinit)；
...
* 详细内容可以见[go 并发之 chan](https://aliang-codes.github.io/my-blogs/pages/f0e212/#_5-chanrecv)；